...
class Ui_DialogBrightnessAndContrastAdjust(object):
    def setupUi(self, DialogBrightnessAndContrastAdjust):
        ...
        self.spinBoxBrightness.setMinimum(-100)
        ...
        self.horizontalSliderContrast.setMinimum(-100)
        self.horizontalSliderContrast.setMaximum(200)
        self.horizontalSliderContrast.setProperty("value", 0)
        ...
        self.spinBoxContrast.setMaximum(200)
